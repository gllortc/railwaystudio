...
namespace Rwm.OTC.Systems.Lenz
{
   internal class Driver : IDigitalSystem
   {
      ...
      public bool Connect()
      {
         ...
         {
            throw new Exception("Cannot open the port " + this.PortName + ": " + ex.Message, ex);
         }
      }
      ...
      {
         return this.SendCommand(new EmergencyStopCommand());
      }
      ...
      public void SetAccessoryStatus(Element element)
      {
         foreach (AccessoryDecoderConnection connection in element.AccessoryConnections)
         {
            ...
            AccessoryDecoderOperationCommand cmd = new AccessoryDecoderOperationCommand(connection.Address,
