...
{
   public class CategoryDAO : CollectionDataEntity
   {
      ...
      public CategoryDAO(XmlSettingsManager settings)
         : base(settings)
      {
      ...
      public void Delete(int itemId)
      {
         ...
         try
         {
            ...
            {
               throw new Exception("No se puede eliminar esta categoría porqué tiene modelos asociados.");
            }
      ...
      public Category GetByID(Int64 categoryId)
      {
         return GetByID((Int32)categoryId);
      }
      ...
      public int GetRelatedModelsCount(int itemId)
      {
         string sql = string.Empty;
      ...
      public System.Data.DataTable GetAllAsDataSource()
      {
         ...
         try
         {
            ...
            sql = @"SELECT 
                        ...
                        typename    As 'Nombre', 
                        typeicon    As 'Icono', 
                        typemaint   As 'Habilitar mantenimiento'
                    FROM 
                        " + CategoryDAO.SQL_TABLE + @" 
                    ORDER BY 
                        typename";
      ...
      /// </summary>
      internal static Category ReadEntityRecord(SQLiteDataReader reader)
      {
