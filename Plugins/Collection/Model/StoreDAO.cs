...
namespace Rwm.Studio.Plugins.Collection.Model
{
   ...
   /// Gestor de comercios.
   /// </summary>
   public class StoreDAO : CollectionDataEntity
   {
      ...
      public void Delete(int itemId)
      {
         ...
         try
         {
            ...
            {
               throw new Exception("No se puede eliminar este comercio porqué tiene modelos asociados.");
            }
      ...
      public Store GetByID(Int64 itemId)
      {
      ...
      /// <param name="itemid">Identificador del modelo.</param>
      /// <returns>Una instáncia de RCStore.</returns>
      public Store GetByID(int itemId)
      {
         string sql = string.Empty;
      ...
      internal static Store ReadEntityRecord(SQLiteDataReader reader)
      {
