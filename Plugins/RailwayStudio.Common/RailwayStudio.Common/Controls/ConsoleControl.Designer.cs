namespace Rwm.Studio.Plugins.Common.Controls
{
   partial class ConsoleControl
   {
      ...
      private void InitializeComponent()
      {
         ...
         // recConsole
         // 
         this.recConsole.ActiveViewType = DevExpress.XtraRichEdit.RichEditViewType.Simple;
         this.recConsole.Appearance.Text.BackColor = System.Drawing.Color.Black;
         this.recConsole.Appearance.Text.BackColor2 = System.Drawing.Color.Black;
         this.recConsole.Appearance.Text.Font = new System.Drawing.Font("Consolas", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
         ...
         this.recConsole.Options.Behavior.CreateNew = DevExpress.XtraRichEdit.DocumentCapability.Disabled;
         this.recConsole.Options.Behavior.Cut = DevExpress.XtraRichEdit.DocumentCapability.Disabled;
         this.recConsole.Options.Behavior.Drag = DevExpress.XtraRichEdit.DocumentCapability.Disabled;
         ...
         this.recConsole.Options.DocumentCapabilities.Fields = DevExpress.XtraRichEdit.DocumentCapability.Disabled;
         this.recConsole.Options.DocumentCapabilities.FloatingObjects = DevExpress.XtraRichEdit.DocumentCapability.Disabled;
         this.recConsole.Options.DocumentCapabilities.FootNotes = DevExpress.XtraRichEdit.DocumentCapability.Disabled;
         this.recConsole.Options.DocumentCapabilities.HeadersFooters = DevExpress.XtraRichEdit.DocumentCapability.Disabled;
         this.recConsole.Options.DocumentCapabilities.Hyperlinks = DevExpress.XtraRichEdit.DocumentCapability.Enabled;
         this.recConsole.Options.DocumentCapabilities.ParagraphFormatting = DevExpress.XtraRichEdit.DocumentCapability.Disabled;
         this.recConsole.Options.DocumentCapabilities.ParagraphFrames = DevExpress.XtraRichEdit.DocumentCapability.Disabled;
         this.recConsole.Options.HorizontalRuler.Visibility = DevExpress.XtraRichEdit.RichEditRulerVisibility.Hidden;
         this.recConsole.Options.HorizontalScrollbar.Visibility = DevExpress.XtraRichEdit.RichEditScrollbarVisibility.Hidden;
         this.recConsole.Options.Printing.EnableCommentBackgroundOnPrint = false;
         this.recConsole.Options.Printing.EnableCommentFillOnPrint = false;
         this.recConsole.Options.Printing.PrintPreviewFormKind = DevExpress.XtraRichEdit.PrintPreviewFormKind.Bars;
         this.recConsole.Options.SpellChecker.AutoDetectDocumentCulture = false;
    ...
    "g sdlfiy galsdyf gasdiy gf";
         this.recConsole.Views.DraftView.BackColor = System.Drawing.Color.Black;
         this.recConsole.Views.SimpleView.BackColor = System.Drawing.Color.Black;
         // 
         // barManager
         // 
         ...
         this.repositoryItemRichEditFontSizeEdit1.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
         this.repositoryItemRichEditFontSizeEdit1.Control = this.recConsole;
         ...
         this.repositoryItemRichEditStyleEdit1.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
         this.repositoryItemRichEditStyleEdit1.Control = this.recConsole;
         ...
         this.stylesBar1.Control = this.recConsole;
         ...
         this.Controls.Add(this.recConsole);
