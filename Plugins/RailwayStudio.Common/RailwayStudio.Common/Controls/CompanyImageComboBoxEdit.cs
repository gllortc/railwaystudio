   ...
   public class CompanyImageComboBoxEdit : ImageComboBoxEdit
   {
      ...
      private void FillItems(Company selected)
      {
         ...
         if (this.Properties.SmallImages == null)
         {
            ...
            this.ImageList.Images.Add(Common.Properties.Resources.ICO_COMPANY_OFF_16);  // No company selected
         ...
         if (OTCContext.Project != null)
         {
            ...
            foreach (Company company in Company.FindAll())
            {
               ...
               {
                  imageKey = "company" + company.ID;
                  this.ImageList.Images.Add(imageKey, company.LogoImage);
                  imageIndex = this.ImageList.Images.IndexOfKey(imageKey);
               }
