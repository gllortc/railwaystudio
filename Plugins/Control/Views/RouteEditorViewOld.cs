...
{
   public partial class RouteEditorViewOld : DevExpress.XtraEditors.XtraForm
   {

      #region Constructors

      /// <summary>
      /// Returns a new instance of <see cref="RouteEditorViewOld"/>.
      /// </summary>
      /// <param name="settings">Current application settings.</param>
      public RouteEditorViewOld()
      {
         InitializeComponent();
      ...
      public RouteEditorViewOld(Route route)
      {
         InitializeComponent();
