...
{
   public partial class FrmActionEditor : DevExpress.XtraEditors.XtraForm
   {
      ...
      public FrmActionEditor(Element ownerBlock, Rwm.Otc.Layout.ElementAction action)
      {
         InitializeComponent();
      ...
      private void ListStatus(int selectedStatus)
      {
         ...
         {
            if (enumInfo.Status > FrmActionEditor.STATUS_UNKNOWN)
            {
               item = new ImageComboBoxItem();
