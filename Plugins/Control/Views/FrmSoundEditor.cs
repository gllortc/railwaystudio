...
{
   public partial class FrmSoundEditor : DevExpress.XtraEditors.XtraForm
   {

      #region Constructors

      /// <summary>
      /// Returns a new instance of <see cref="FrmSoundEditor"/>.
      /// </summary>
      public FrmSoundEditor()
      {
         InitializeComponent();
      ...
      public FrmSoundEditor(Sound sound)
      {
         InitializeComponent();
