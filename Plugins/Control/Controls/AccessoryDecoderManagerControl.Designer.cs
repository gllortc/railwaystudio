...
{
   partial class AccessoryDecoderManagerControl
   {
      /// <summary> 
      ...
      private void InitializeComponent()
      {
         ...
         // cmdDecoderAdd
         // 
         this.cmdDecoderAdd.Caption = "Add new accessory decoder";
         ...
         // 
         // AccessoryDecoderManagerControl
         // 
         ...
         this.Name = "AccessoryDecoderManagerControl";
