...
{
   partial class BlockPropertiesViews
   {
      /// <summary>
      ...
      private void InitializeComponent()
      {
         ...
         this.tabAccessoryInputs = new DevExpress.XtraTab.XtraTabPage();
         this.tabAccessoryMap = new DevExpress.XtraTab.XtraTabPage();
         ...
         this.tabAccessoryConnections.Image = Properties.Resources.ICO_DEVICE_ACC_16;
         ...
         // tabAccessoryMap
         // 
         this.tabAccessoryMap.Name = "tabAccessoryMap";
         this.tabAccessoryMap.Padding = new System.Windows.Forms.Padding(10);
         this.tabAccessoryMap.Size = new System.Drawing.Size(415, 325);
         this.tabAccessoryMap.Text = "Connection map";
         // 
         // tabFeedbackConnections
         // 
         this.tabFeedbackConnections.Image = Properties.Resources.ICO_DEVICE_FB_16;
         ...
         // tabBlockActions
         // 
         this.tabBlockActions.Image = Properties.Resources.ICO_ACTION_16;
         ...
         this.Name = "BlockPropertiesViews";
         this.ShowIcon = false;
      ...
      private DevExpress.XtraTab.XtraTabPage tabAccessoryInputs;
      private DevExpress.XtraTab.XtraTabPage tabAccessoryMap;
   }
}