...
{
   public class ModelRevisionDAO : CollectionDataEntity
   {
      ...
      public ModelRevisionDAO(XmlSettingsManager settings) : base(settings) { }
      ...
      /// </remarks>
      public List<ModelRevision> GetByModel(int modelId)
      {
         string sql = string.Empty;
