...
namespace Rwm.Studio.Plugins.Collection.Model
{
   ...
   public class AdministrationDAO : CollectionDataEntity
   {
      ...
      public void Delete(int itemid)
      {
         ...
         try
         {
            ...
            {
               throw new Exception("No se puede eliminar esta administración/operadora porqué tiene modelos asociados.");
            }
      ...
      public Administration GetByID(Int32 itemId)
      {
      ...
      public Administration GetByID(Int64 itemId)
      {
         string sql = string.Empty;
         ...
         try
         {
            ...
            using (SQLiteDataReader reader = ExecuteReader(sql))
            {
               if (reader.Read())
               {
                  item = AdministrationDAO.ReadEntityRecord(reader);
               }
            }
      ...
      public List<Administration> GetAll()
      {
         ...
         try
         {
            ...
            using (SQLiteDataReader reader = ExecuteReader(sql))
            {
               while (reader.Read())
               {
                  admin = AdministrationDAO.ReadEntityRecord(reader);
                  if (admin != null)
                  {
                     admins.Add(admin);
                  }
      ...
      /// </summary>
      internal static Administration ReadEntityRecord(SQLiteDataReader reader)
      {
