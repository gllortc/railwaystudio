...
{
   partial class ModulesManagerView
   {
      /// <summary>
      ...
      private void InitializeComponent()
      {
         ...
         this.grdAreasView = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridView();
         ...
         // cmdAreaAdd
         // 
         this.cmdAreaAdd.Caption = "Add new module";
         ...
         // cmdAreaEdit
         // 
         this.cmdAreaEdit.Caption = "Edit module";
         ...
         // cmdAreaDelete
         // 
         this.cmdAreaDelete.Caption = "Delete module";
         ...
         // grdAreasView
         // 
         this.grdAreasView.Bands.AddRange(new DevExpress.XtraGrid.Views.BandedGrid.GridBand[] {
            this.gridBand1});
         ...
         this.Name = "ModulesManagerView";
         this.ShowIcon = false;
         this.ShowInTaskbar = false;
         this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
         this.Text = "Layout modules";
      ...
      private DevExpress.XtraGrid.Views.BandedGrid.BandedGridView grdAreasView;
