...
{
   public class ORMTableStructure : IEnumerable<ORMEntityMember>
   {

      #region Constructor

      /// <summary>
      /// Return a new instance of <see cref="ORMTableStructure"/> filled with all ORM information related to type <c>T</c>.
      /// </summary>
      public ORMTableStructure(Type ownerType)
      {
         ...
         this.ForeignFields = new List<ORMEntityMember>();
         ...
         foreach (PropertyInfo pi in this.OwnerType.GetProperties())
         {
            ...
            if (member != null) 
            {
               ...
               else if (member.IsForeignField)
               {
                  this.ForeignFields.Add(member);
                  this.All.Add(member);
               }
      ...
      /// <summary>
      /// Gets a list of foreign fields.
      /// </summary>
      public List<ORMEntityMember> ForeignFields { get; private set; }
