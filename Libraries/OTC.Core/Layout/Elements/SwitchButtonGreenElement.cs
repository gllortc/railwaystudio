...
namespace Rwm.Otc.Layout.Elements
{
   ...
   /// </summary>
   public class SwitchButtonGreenElement : ElementBase, IAccessory
   {
      ...
      /// <summary>
      /// Returns a new instance of <see cref="SwitchButtonGreenElement"/>.
      /// </summary>
      public SwitchButtonGreenElement()
      {
         Initialize();
      }
      ...
      {
         get { return (Image)global::Rwm.Otc.Properties.Resources.ICO_DESIGN_SWITCH_FREEN_16; }
      }
      ...
      {
         get { return ElementType.SwitchButtonGreen; }
      }
