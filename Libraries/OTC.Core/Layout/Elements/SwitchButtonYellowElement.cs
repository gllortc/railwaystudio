...
namespace Rwm.Otc.Layout.Elements
{
   ...
   /// </summary>
   public class SwitchButtonYellowElement : ElementBase, IAccessory
   {
      ...
      /// <summary>
      /// Returns a new instance of <see cref="SwitchButtonYellowElement"/>.
      /// </summary>
      public SwitchButtonYellowElement()
      {
         Initialize();
      }
      ...
      public new ElementBase.RotationStep Rotation
      {
      ...
      {
         get { return (Image)global::Rwm.Otc.Properties.Resources.ICO_DESIGN_SWITCH_YELLOW_16; }
      }
      ...
      {
         get { return ElementType.SwitchButtonYellow; }
      }
