...
namespace Rwm.Otc.Layout.Elements
{
   ...
   /// </summary>
   public class SwitchButtonBlueElement : ElementBase, IAccessory
   {
      ...
      /// <summary>
      /// Returns a new instance of <see cref="SwitchButtonBlueElement"/>.
      /// </summary>
      public SwitchButtonBlueElement()
      {
         Initialize();
      }
      ...
      {
         get { return (Image)global::Rwm.Otc.Properties.Resources.ICO_DESIGN_SWITCH_BLUE_16; }
      }
      ...
      {
         get { return ElementType.SwitchButtonBlue; }
      }
