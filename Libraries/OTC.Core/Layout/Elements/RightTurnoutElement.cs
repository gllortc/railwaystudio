...
{
   /// <summary>
   /// Implementation of right turnout element (with digital function).
   /// </summary>
   public class RightTurnoutElement : ElementBase, IAccessory, IRoutable
   {
      ...
      /// <summary>
      /// Returns a new instance of <see cref="RightTurnoutElement"/>.
      /// </summary>
      public RightTurnoutElement()
      {
         Initialize();
      }
      ...
      {
         get { return (Image)global::Rwm.Otc.Properties.Resources.ICO_DESIGN_TURNOUT_RIGHT_16; }
      }
      ...
      {
         get { return ElementType.TurnoutRight; }
      }
