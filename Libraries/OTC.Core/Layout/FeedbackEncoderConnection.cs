...
namespace Rwm.Otc.Layout
{
   ...
   public class FeedbackEncoderConnection : ORMEntity<FeedbackEncoderConnection>, IComparable<FeedbackEncoderConnection>
   {
      ...
      public FeedbackEncoder Device { get; set; }
      ...
      /// <summary>
      /// Get a <see cref="FeedbackEncoderConnection"/> by its device output.
      /// </summary>
      /// <param name="element">Owner connection <see cref="Element"/>.</param>
      /// <param name="output"><see cref="FeedbackEncoderConnection"/> index.</param>
      /// <returns>The requested <see cref="FeedbackEncoderConnection"/> or <c>null</c> if no <see cref="FeedbackEncoderConnection"/> is used by the specified <see cref="Element"/> and index.</returns>
      public static FeedbackEncoderConnection GetByInput(Element element, int output)
      {
      ...
      /// <summary>
      /// Get a <see cref="FeedbackEncoderConnection"/> by its index.
      /// </summary>
      /// <param name="element">Owner connection <see cref="Element"/>.</param>
      /// <param name="index"><see cref="FeedbackEncoderConnection"/> index.</param>
      /// <returns>The requested <see cref="AccessoryDecoderConnection"/> or <c>null</c> if no <see cref="FeedbackEncoderConnection"/> is used by the specified <see cref="Element"/> and index.</returns>
