...
namespace Rwm.Otc.Layout.Persistence
{
   ...
   /// Sounds data manager.
   /// </summary>
   public class SoundDAO : DataConsumer
   {
      ...
      /// <summary>
      /// Returns a new instance of <see cref="SoundDAO"/>.
      /// </summary>
      public SoundDAO() : base() { }
...
//         Logger.LogDebug(this, "[CLASS].Add([{0}])", sound);
...
//            sql = @"INSERT INTO 
//                        " + SoundDAO.SQL_TABLE + @" (" + SoundDAO.SQL_FIELDS_INSERT + @") 
//                    VALUES 
//                        (@name, @filename, @sounddata)";

//            SetParameter("name", sound.Name);
//            SetParameter("filename", Path.GetFileName(sound.Filename));
//            SetParameter("sounddata", File.ReadAllBytes(sound.Filename));
...
//            sound.Filename = Path.GetFileName(sound.Filename);
//         }
//         catch (Exception ex)
//         {
...
//               while (reader.Read())
//               {
//                  item = this.ReadEntityRecord(reader, false);
//                  if (item != null)
//                  {
//                     items.Add(item);
//                  }
...
//      public Sound GetByID(long itemId)
//      {
//         return this.GetByID(itemId, false);
//      }
...
//      /// <param name="readSoundData">A value indicating if the sound must be loaded into a stream.</param>
//      /// <returns>The requested <see cref="Sound"/> instance or <c>null</c> if the specified sound doesn't exists.</returns>
//      public Sound GetByID(long itemId, bool readSoundData)
//      {
//         string sql = string.Empty;
...
//               if (reader.Read())
//               {
//                  return this.ReadEntityRecord(reader, readSoundData);
//               }
//            }
...
//      /// </summary>
//      /// <param name="itemId">Sound unique identifier (DB).</param>
//      public void PlaySound(Int32 itemId)
//      {
//         this.PlaySound((Int64)itemId);
//      }
      ...
      ///// </summary>
      ///// <param name="itemId">Sound unique identifier (DB).</param>
      //public void PlaySound(Int64 itemId)
      //{
      //   bool played = false;
      ...
      //   try
      //   {
      //      sound = Sound.Get(itemId);

      //      path = Path.Combine(GetCacheFolder(), sound.GetCacheFilename());
      //      if (!File.Exists(path))
      //      {
      //         sound = Sound.Get(itemId);
      ...
      ///// </summary>
      //public Sound ReadEntityRecord(SQLiteDataReader reader)
      //{
      //   return this.ReadEntityRecord(reader, false);
      //}

      ///// <summary>
      ///// Read an entity from the current reader record.
      ///// </summary>
      //public Sound ReadEntityRecord(SQLiteDataReader reader, bool getFileData)
      //{
      ...
      //   if (getFileData)
      //   {
      //      record.SoundStream = SoundDAO.ReadSoundFile(reader);
      //   }
