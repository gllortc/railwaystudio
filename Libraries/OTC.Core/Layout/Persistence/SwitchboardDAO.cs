...
namespace Rwm.Otc.Layout.Persistence
{
   ...
   /// </summary>
   public class SwitchboardDAO : DataConsumer
   {

      #region Constants

      // SQL declarations
      internal static string SQL_TABLE = "switchboards";
      ...
      /// <summary>
      /// Returns a new instance of <see cref="SwitchboardDAO"/>.
      /// </summary>
      public SwitchboardDAO() : base() { }
...
//      /// </summary>
//      /// <param name="panel">An instance of <see cref="Switchboard"/> containing the data for the new panel.</param>
//      public void Add(Switchboard panel)
//      {
...
//            // Añade el registro
//            sql = @"INSERT INTO 
//                        " + SwitchboardDAO.SQL_TABLE + @" (" + SwitchboardDAO.SQL_FIELDS_INSERT + @") 
//                    VALUES 
...
//      public void Update(Switchboard panel)
//      {
//         string sql = string.Empty;
...
//      /// <returns>The requested <see cref="Switchboard"/> instance filled with all data.</returns>
//      public Switchboard GetByID(long id)
//      {
//         string sql = string.Empty;
//         Switchboard item = null;
...
//            sql = @"SELECT 
//                        " + SwitchboardDAO.SQL_FIELDS_SELECT + @" 
//                    FROM 
//                        " + SwitchboardDAO.SQL_TABLE + @" 
//                    WHERE 
//                        id = @id";
...
//      /// <returns>The requested instance of <see cref="Switchboard"/>.</returns>
//      public Switchboard GetByName(string name)
//      {
//         string sql = string.Empty;
//         Switchboard item = null;
...
//      public IEnumerable<Switchboard> GetAll()
//      {
//         string sql = string.Empty;
//         Switchboard item;
//         List<Switchboard> items = new List<Switchboard>();
...
//      }
      ...
      ///// </summary>
      //public Switchboard ReadEntityRecord(SQLiteDataReader reader)
      //{
      //   Switchboard record = new Switchboard();
