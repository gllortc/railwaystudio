...
{
   public class DecoderDAO : DataManager<Decoder>
   {
...
//      public override void Add(Decoder decoder)
//      {
...
//      /// </summary>
//      /// <param name="model">Una instáncia de RCDecoder.</param>
//      public override void Update(Decoder decoder)
//      {
//         string sql = string.Empty;
...
//            {
//               throw new Exception("This decoder cannot be deleted because it has related models.");
//            }
...
//      public override Decoder GetByID(long itemId)
//      {
//         string sql = string.Empty;
...
//      public override IEnumerable<Decoder> GetAll()
//      {
//         string sql = string.Empty;
...
//               while (reader.Read())
//               {
//                  items.Add(this.ReadEntityRecord(reader));
//               }
//               reader.Close();
//            }
...
//      }
      ...
      public override Decoder ReadEntityRecord(SQLiteDataReader reader)
      {
