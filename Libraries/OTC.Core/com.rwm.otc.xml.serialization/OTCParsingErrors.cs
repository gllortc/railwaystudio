...
namespace Rwm.Otc.xml.serialization
{
   ...
   /// </summary>
   public class OTCParsingErrors
   {
      private List<KeyValuePair<OTCException, OTCExceptionTypes>> listExceptions = new List<KeyValuePair<OTCException, OTCExceptionTypes>>();
      ...
      {
         get { return this.listExceptions.Count > 0; }
      }
      ...
      public int Count
      {
         get { return this.listExceptions.Count; }
      }
      ...
      /// <value></value>
      public KeyValuePair<OTCException, OTCExceptionTypes> this[int n]
      {
         get { return this.listExceptions[n]; }
      }
      ...
      public void AddRange(OTCParsingErrors parsingErrors)
      {
