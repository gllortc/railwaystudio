...
{
   public class ManufacturerDAO : DataManager<Manufacturer>
   {
...
//      /// </summary>
//      /// <param name="model">Una instáncia de RCManufacturer.</param>
//      public override void Update(Manufacturer manufacturer)
//      {
//         string sql = string.Empty;
...
//            {
//               throw new Exception("This manufacturer cannot be deleted because it has related models.");
//            }
...
//      public override Manufacturer GetByID(long itemId)
//      {
//         string sql = string.Empty;
...
//               while (reader.Read())
//               {
//                  manufacturer = this.ReadEntityRecord(reader);
...
//      }
      ...
      public System.Data.DataTable GetAllAsDataSource()
      {
         ...
         try
         {
            ...
            sql = @"SELECT 
                        buildid        As '#ID', 
                        buildname      As 'Name',
                        builddesc      As 'Description', 
                        buildurl       As 'URL',
                        buildaddress   As 'Address'
                    FROM 
                        " + ManufacturerDAO.SQL_TABLE + @" 
                    ORDER BY 
                        buildname";
      ...
      public override Manufacturer ReadEntityRecord(SQLiteDataReader reader)
      {
