...
{
   public class ScaleDAO : DataManager<Scale>
   {
...
//      public override void Add(Scale scale)
//      {
...
//      /// </summary>
//      /// <param name="model">Una instáncia de RCScale.</param>
//      public override void Update(Scale scale)
//      {
//         string sql = string.Empty;
...
//      public override Scale GetByID(long itemId)
//      {
//         string sql = string.Empty;
...
//            if (this.CountItems(itemId) > 0)
//            {
//               throw new Exception("This scale cannot be deleted because it has related models.");
//            }
...
//      public override IEnumerable<Scale> GetAll()
//      {
//         string sql = string.Empty;
//         Scale scale;
...
//               while (reader.Read())
//               {
//                  scale = this.ReadEntityRecord(reader);
//                  if (scale != null)
//                  {
//                     scales.Add(scale);
//                  }
...
//      }
      ...
      public System.Data.DataTable GetAllAsDataTable()
      {
         ...
         try
         {
            ...
            sql = @"SELECT 
                        ...
                        scname      As 'Name',
                        scscale     As 'Notation', 
                        sctwidth    As 'Scale wide (mm)',
                        scrtwidth   As 'Real wide (mm)'
                    FROM 
                        " + ScaleDAO.SQL_TABLE + @" 
                    ORDER BY 
                        scname";
      ...
      public override Scale ReadEntityRecord(SQLiteDataReader reader)
      {
