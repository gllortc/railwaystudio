...
namespace Rwm.Otc.TrainControl
{
   ...
   /// </summary>
   [ORMTable("models")]
   public class CollectionModel : ORMEntity<CollectionModel>
   {
      ...
      /// Esquema de pintura
      /// </summary>
      [ORMProperty("modpaint")]
      public string PaintScheme { get; set; }

      /// <summary>
      /// Época
      /// </summary>
      [ORMProperty("modepoche")]
      ...
      /// </summary>
      [ORMProperty("moddigitaldecoderid")]
      public Decoder DigitalDecoder { get; set; }
      ...
      //   if (this.AdminID > 0)
      //   {
      //      Administration admin = OTCContext.Project.TrainManager.AdministrationDAO.GetByID(this.AdminID);
